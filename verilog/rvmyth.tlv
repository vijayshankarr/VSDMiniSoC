...
\TLV
   ...
   |cpu
      ...
      @3   
         //Valid signal - taken_branch, load, jump
         ...
         $sltui_rslt[31:0] = $src1_value < $imm ;
         $slt = ($src1_value[31] == $src1_value[31]) ? $sltu_rslt : {31'b0, $src1_value[31]};
         $slti = ($src1_value[31] == $imm[31]) ? $sltui_rslt : {31'b0, $src1_value[31]};
